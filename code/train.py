...
tf.app.flags.DEFINE_integer("question_size", 25, "Size of q (default 60)")
tf.app.flags.DEFINE_integer("para_size", 300, "The para size (def 800)")
tf.app.flags.DEFINE_integer("max_decode_steps", 4, "Maximum number of decode steps (default 4)")
tf.app.flags.DEFINE_integer("maxout_size", 16, "Size of maxout in decoder (default 32)")
